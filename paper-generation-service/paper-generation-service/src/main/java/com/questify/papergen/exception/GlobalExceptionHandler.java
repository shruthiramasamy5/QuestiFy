...
import com.questify.papergen.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleGeneration(GenerationException ex) {
        return ResponseEntity.unprocessableEntity()
                .body(ApiError.of(422, "Generation Failed", ex.getMessage(), Map.of()));
    }
    ...
    public ResponseEntity<ApiError> handleAi(AiProviderNotConfiguredException ex) {
        return ResponseEntity.status(HttpStatus.NOT_IMPLEMENTED)
                .body(ApiError.of(501, "AI Not Configured", ex.getMessage(), Map.of()));
    }
